...
public class Window1
{
    ...
    public Window1()
    {
         ...
         //mainBox = new RoundedBox(new Position(0.24f, 0.1f), new Bounds(0.5f, 0.87f), Pallet.SecondaryColor,
          ...
          Viewport = new Viewport(new Position(0.23f, 0.11f), new Position(0.40f, 0.85f),viewportDraws);
          ...
          homeButton =
              new PictureButton<int, int>(new Position(0.05f, 0.05f), OpenHomeWindow,1,"Resources/Icons/houseIcon.png",scale:0.5f );
